package com.ahmedeid.hibernatedemo.hibernateutil;
...
public class HibernateUtil {
    ...
    private static SessionFactory buildSessionJavaConfigFactory() {
        try {
            ...
            props.put("hibernate.connection.url", "jdbc:mysql://localhost/student_managment");
            props.put("hibernate.connection.username", "root");
            props.put("hibernate.connection.password", "a7med ZIDAN 002255447788");
